"""
Реализация скатерти Улама.
"""

"""
Константные значения направлений. 
Каждое направление хранится как кортеж из двух чисел - смещения по горизонтали и смещения по вертикали. 
"""
DIRECTION_LEFT = (-1, 0)
DIRECTION_RIGHT = (1, 0)
DIRECTION_UP = (0, -1)
